...
import com.example.Luna.security.token.Token;
import com.example.Luna.security.token.TokenRepository;
import com.example.Luna.security.token.TokenType;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse register(RegisterRequest request) {
        ...
        Role role = roleRepository.findByName(RoleEnum.ROLE_USER.name())
                .orElse(Role.builder().name(RoleEnum.ROLE_USER.name()).build());
        user.addRole(role);
